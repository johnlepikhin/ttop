...
src/AppSettings.o: ../src/AppSettings.cpp
	...
	g++ -std=c++0x -I../../cpp-quilt-strings/src -I../../TrafficProcessor/src -O0 -g3 -ftest-coverage -fprofile-arcs -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"src/AppSettings.d" -o "$@" "$<"
